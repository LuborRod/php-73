...
class BasicsTest extends TestCase
{
    ...
    public function testArithmeticOperators()
    {
        ...
        // Multiplication
        $this->assertEquals(15, 5 * 3);

        // Division
        $this->assertEquals(10, 30 / 3);
    ...
    public function testTypeJuggling()
    {
        ...
        $foo = 5;
        $this->assertIsFloat($foo * 1.3);

        $foo = 6;
        $this->assertIsInt($foo * (int)"10 Little Piggies");

        $foo = 7;
        $this->assertIsInt($foo * (int)"10 Small Pigs");
